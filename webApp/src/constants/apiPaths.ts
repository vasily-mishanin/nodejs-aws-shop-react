const API_PATHS = {
  ...
  //BFF - direct
  // product: "http://vasily-mishanin-bff-api-bfftest.us-east-1.elasticbeanstalk.com",
  // cart: "http://vasily-mishanin-bff-api-bfftest.us-east-1.elasticbeanstalk.com",

  // BFF  - HTTPS proxy
  product:
    'http://vasily-mishanin-bff-api-bfftest.us-east-1.elasticbeanstalk.com',
  cart: 'https://a4lbovzku0.execute-api.us-east-1.amazonaws.com',
};
